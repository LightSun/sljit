...
//SLJIT_S0, SLJIT_S1... 接收参数.也就是save register
    /* R0 = 0 */
    ...
    /* RET += b */
    sljit_emit_op2(C, SLJIT_ADD, SLJIT_RETURN_REG, 0,
                   SLJIT_RETURN_REG, 0, SLJIT_S1, 0);
    /* R1 += 1 */
